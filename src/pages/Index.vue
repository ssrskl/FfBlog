<script setup>
import {ref} from "vue";
import {navigateToLogin, navigateToRegister} from "@/router/router";
...
function SearchArticle() {
  if (searchContent.value === '') {
    ...
    ElNotification({
      title: '成功',
      message: '搜索成功'+searchContent.value,
      type: 'success'
    })
  }
}
...
<template>
  ...
  <div class="flex flex-col items-center w-full bg-gray-200 min-h-screen h-auto">
    <div class="flex-1 flex flex-col w-3/4">
      <nav class="fixed w-3/4 z-20 flex justify-between text-gray-500 bg-gray-100 px-3 drop-shadow-md">
        <div class="flex justify-between items-center space-x-16 py-3 px-4">
          ...
          <div class="flex items-center">
            <input type="text"
                   class="z-10 rounded-l-full bg-white text-xs py-2 px-2 border-0 focus:outline-none hover:bg-gray-200 focus:ring-2"
                   placeholder="搜索 (ctrl+k)"
                   v-model="searchContent"/>
            <!--搜索按钮-->
            <button class="rounded-r-full bg-white px-2 py-2" @click="SearchArticle">
        ...
        <div class="flex items-center justify-between">
          <div class="flex space-x-2 mr-4">
            <a href="#" class="flex items-center hover:text-blue-400">
              <div class="w-8 h-8 rounded-full bg-blue-400 overflow-hidden">
                <img src="https://avatars.githubusercontent.com/u/18780761?v=4"/>
              </div>
            </a>
            <div class="flex flex-col">
              <span>Connies's Butterfly...</span>
              <div class="flex items-center space-x-4">
                <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"
                     fill="none" stroke-linecap="round" stroke-linejoin="round" class="w-3">
          ...
          <div class="flex items-center space-x-2">
            <button class="py-3 px-3 rounded-md hover:bg-gray-200">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                   fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                   stroke-linejoin="round" class="w-4">
            ...
            <!--跳转登录页面-->
            <el-dropdown>
              <button class="flex py-3 px-3 rounded-md hover:bg-gray-200 space-x-1.5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                     stroke-linejoin="round" class="w-4">
                  <path
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item @click="navigateToLogin()">登录</el-dropdown-item>
                  <el-dropdown-item @click="navigateToRegister()">注册</el-dropdown-item>
                </el-dropdown-menu>
              </template>
            </el-dropdown>
          </div>
      ...
      <div class="flex w-full flex-grow mt-16">
        <!--sidebar-->
        <!--想要设置flex-grow来充满，首先父容器要设置确定的高度-->
        ...
        <!--右半边-->
        <aside class="flex flex-col w-1/5 text-gray-500 text-sm px-3 py-6 bg-gray-50 drop-shadow-md">
          <div class="flex rounded-full bg-gray-200 justify-between">
            <button class="flex items-center px-6 py-1 bg-gray-300 rounded-full">
            ...
            <button class="flex items-center px-6 py-1 rounded-full">
              <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24"
                   fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                   stroke-linejoin="round" class="w-4">
          ...
          <div>
            <ul class="flex flex-col space-y-6 pt-4">
              <li class="flex space-x-2">
                <a href="#" class="flex items-center ">
                  <div class="w-10 h-10 rounded-md drop-shadow-md overflow-hidden ">
                    <img src="https://www.ihewro.com/usr/themes/handsome/assets/img/sj2/4.jpg"
                         class="w-10 h-10 rounded-md"/>
                  </div>
                </a>
                <div class="flex flex-col w-40">
                  <p class="truncate">handsome —— 一款typdasdsada</p>
              ...
              <li class="flex space-x-2">
                <a href="#" class="flex items-center ">
                  <div class="w-10 h-10 rounded-md drop-shadow-md overflow-hidden ">
                    <img src="https://www.ihewro.com/usr/themes/handsome/assets/img/sj2/2.jpg"
                         class="w-10 h-10 rounded-md"/>
                  </div>
                </a>
                <div class="flex flex-col w-40">
              ...
              <li class="flex space-x-2">
                <a href="#" class="flex items-center ">
                  <div class="w-10 h-10 rounded-md drop-shadow-md overflow-hidden ">
                    <img src="https://www.ihewro.com/usr/themes/handsome/assets/img/sj2/6.jpg"
                         class="w-10 h-10 rounded-md"/>
                  </div>
                </a>
                <div class="flex flex-col w-40">
              ...
              <li class="flex space-x-2">
                <a href="#" class="flex items-center ">
                  <div class="w-10 h-10 rounded-md drop-shadow-md overflow-hidden ">
                    <img src="https://www.ihewro.com/usr/themes/handsome/assets/img/sj2/9.jpg"
                         class="w-10 h-10 rounded-md"/>
                  </div>
                </a>
                <div class="flex flex-col w-40">
              ...
              <li class="flex space-x-2">
                <a href="#" class="flex items-center ">
                  <div class="w-10 h-10 rounded-md drop-shadow-md overflow-hidden ">
                    <img src="https://www.ihewro.com/usr/themes/handsome/assets/img/sj2/5.jpg"
                         class="w-10 h-10 rounded-md"/>
                  </div>
                </a>
                <div class="flex flex-col w-40">
          ...
          <div class="w-full mt-8 text-gray-500 space-y-2">
            <span>博客信息</span>
            <div>
              <div>
                <div class="bg-white drop-shadow-md flex justify-between px-2 py-3">
                  <button class="flex space-x-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                         viewBox="0 0 24 24"
                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                         stroke-linejoin="round" class="w-3">
                      <circle cx="12" cy="8" r="7"></circle>
                      <polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline>
                    </svg>
                    <span>文章数目</span>
                  </button>
                  <span class="px-2 py-0.5 bg-gray-200 rounded-md text-xs font-semibold">258</span>
                </div>
                <div class="bg-white drop-shadow-md flex justify-between px-2 py-3">
                  <button class="flex space-x-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                  ...
                  <span class="px-2 py-0.5 bg-gray-200 rounded-md text-xs font-semibold">8102</span>
                </div>
                <div class="bg-white drop-shadow-md flex justify-between px-2 py-3">
                  <button class="flex space-x-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                  ...
                  <span class="px-2 py-0.5 bg-gray-200 rounded-md text-xs font-semibold">365天</span>
                </div>
                <div class="bg-white drop-shadow-md flex justify-between px-2 py-3">
                  <button class="flex space-x-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                  ...
                  <span class="px-2 py-0.5 bg-gray-200 rounded-md text-xs font-semibold">1周前</span>
                </div>
              </div>
            </div>
          </div>
